...
<main class="main-cont">
    ...
    <div class="main-grid">
        ...
        <div class="panel">
            ...
            <form id="overtime-form-section" class="request-form hidden" action="../process/submit-request.php" method="POST" enctype="multipart/form-data">
...
<script>
const leaveTab=document.getElementById("tab-leave"),overtimeTab=document.getElementById("tab-overtime"),leaveForm=document.getElementById("leave-form-section"),overtimeForm=document.getElementById("overtime-form-section");

leaveTab.onclick=()=>{leaveTab.classList.add("active");overtimeTab.classList.remove("active");leaveForm.classList.remove("hidden");overtimeForm.classList.add("hidden")};
overtimeTab.onclick=()=>{overtimeTab.classList.add("active");leaveTab.classList.remove("active");overtimeForm.classList.remove("hidden");leaveForm.classList.add("hidden")};
</script>

<script>
const overtimeStart=document.getElementById("overtime_start"),overtimeEnd=document.getElementById("overtime_end"),totalHours=document.getElementById("total_hours");

function calculateOvertime(){
    if(!overtimeStart.value||!overtimeEnd.value){totalHours.value="--:--";return}

    const start=new Date(`1970-01-01T${overtimeStart.value}`);
    const end=new Date(`1970-01-01T${overtimeEnd.value}`);

    if(end<=start){totalHours.value="--:--";return}

    const minutes=(end-start)/60000,hours=Math.floor(minutes/60),mins=minutes%60;
